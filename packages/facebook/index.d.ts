...
export declare class LoginManager implements ILoginManager {
	...
	static logInWithPermissions(permissions: string[], context?: any /* UIViewController to open from on iOS, Activity to open with on Android */, nonce?: string): Promise<LoginResult>;
